...
namespace Biasfish.Core
{
    ...
    {
        public const ulong FileA = 0x0101010101010101UL << (int)File.FileA;
        public const ulong FileB = 0x0101010101010101UL << (int)File.FileB;
        public const ulong FileC = 0x0101010101010101UL << (int)File.FileC;
        public const ulong FileD = 0x0101010101010101UL << (int)File.FileD;
        public const ulong FileE = 0x0101010101010101UL << (int)File.FileE;
        public const ulong FileF = 0x0101010101010101UL << (int)File.FileF;
        public const ulong FileG = 0x0101010101010101UL << (int)File.FileG;
        public const ulong FileH = 0x0101010101010101UL << (int)File.FileH;

        public const ulong Rank1 = 0xFFUL << (int)Rank.Rank1;
        public const ulong Rank2 = 0xFFUL << (int)Rank.Rank2;
        public const ulong Rank3 = 0xFFUL << (int)Rank.Rank3;
        public const ulong Rank4 = 0xFFUL << (int)Rank.Rank4;
        public const ulong Rank5 = 0xFFUL << (int)Rank.Rank5;
        public const ulong Rank6 = 0xFFUL << (int)Rank.Rank6;
        public const ulong Rank7 = 0xFFUL << (int)Rank.Rank7;
        public const ulong Rank8 = 0xFFUL << (int)Rank.Rank8;
